...
import com.chat.cs6650assignment2.consumer.RabbitMQConsumerService;
...
/**
 * This class implements ApplicationRunner, which guarantees its `run` method is executed
 * after the Spring application context is fully loaded. This is the ideal place to
 * programmatically configure and start our dynamic, multi-threaded consumers.
 */
@Component
